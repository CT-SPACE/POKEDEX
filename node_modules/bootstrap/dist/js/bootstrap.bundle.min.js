...
!(function (t, e) {
  ...
  const F = {
    ...
    getDataAttributes (t) {
      ...
      for (const n of i) {
        let i = n.replace (/^bs/, '');
        (i = i.charAt (0).toLowerCase () + i.slice (1, i.length)), (e[i] = M (
          t.dataset[n]
        ));
      }
      return e;
  ...
  class Bt extends W {
    ...
    show () {
      ...
      this._element.classList.remove (
        Pt
      ), this._element.classList.add (Mt), (this._element.style[e] = 0), this._addAriaAndCollapsedClass (this._triggerArray, !0), (this._isTransitioning = !0);
    ...
    hide () {
      ...
      (this._element.style[
        t
      ] = `${this._element.getBoundingClientRect ()[t]}px`), d (this._element), this._element.classList.add (Mt), this._element.classList.remove (Pt, Nt);
